  ...
  return (
    <div className="min-h-[100dvh] bg-[#050505] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#1a1a2e] via-[#050505] to-[#000000] text-white p-4 font-sans uppercase pb-20 overflow-y-auto">
      ...
      <div className="max-w-3xl mx-auto flex flex-col md:flex-row justify-between items-center mb-6 mt-4 border-b border-gray-600 pb-4 shadow-[0_4px_15px_-5px_rgba(255,255,255,0.1)] gap-4">
        ...
        {/* Đã thêm nút RẢI KÈO vào thanh điều hướng trên cùng */}
        <div className="flex flex-wrap justify-center md:justify-end gap-2">
          <Link href="/matchmaking" className="bg-[#0d0d0d] border border-[#b537f2] text-[#b537f2] active:opacity-50 px-4 py-2 rounded font-black transition-opacity shadow-[0_0_10px_rgba(181,55,242,0.2)] tracking-widest text-xs sm:text-sm touch-manipulation">
            ⚡ RẢI KÈO
          </Link>
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-[#0d0d0d] p-5 md:p-6 rounded border border-[#00f3ff]/30 shadow-[0_0_15px_rgba(0,243,255,0.1)] relative overflow-hidden">
          ...
          {/* NÚT ĐI NHANH QUA RẢI KÈO SAU KHI ADD XONG */}
          {players.length > 0 && (
            <div className="mt-8 flex justify-end relative z-10 border-t border-[#00f3ff]/20 pt-4">
              <Link href="/matchmaking" className="bg-[#0d0d0d] border border-[#b537f2] text-[#b537f2] active:opacity-50 px-6 py-3 rounded font-black transition-opacity shadow-[0_0_10px_rgba(181,55,242,0.2)] tracking-widest text-sm touch-manipulation flex items-center gap-2">
                TIẾP TỤC RẢI KÈO ➔
              </Link>
            </div>
          )}
